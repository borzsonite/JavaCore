...
public class Main {
    public static void main(String[] args) {
        Experience experience = new Experience("ЮФУ",  LocalDate.of(1999, 12, 11),  LocalDate.of(2004, 12, 11), "Инженер");
        ...
        TestResume resume = new TestResume("uuid1", "Bob", experience, objectivesSectionList);
